...
const HeaderIcon2: FC<SvgIconProps> = props => (
    <SvgIcon {...props} width="57" height="57" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="30" cy="30" r="30" fill="#ffbe98" />
        <g clipPath="url(#clip0_147_1132)">
            <path
